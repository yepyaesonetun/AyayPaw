...
//        TextView t = (TextView)v.findViewById(R.id.textView_t2);
//        t.setTypeface(f);
        ListView lv = (ListView) v.findViewById(R.id.lst_tab_2);
    ...
    public void Volunteer() {
        ...
        if (cursor.getCount() > 0) {
            ...
            String ss = cursor.getString(cursor.getColumnIndex("Volunteer"));
            try {
                SplitListString(ss);
            } catch (Exception e) {
                data[0] = ss;
